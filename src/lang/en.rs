...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the DaFu Remote network..."),
        ...
        ("install_tip", "Due to UAC, DaFu Remote can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install DaFu Remote to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant DaFu Remote \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant DaFu Remote \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow DaFu Remote to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [DaFu Remote Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next DaFu Remote application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant DaFu Remote \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant DaFu Remote \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running DaFu Remote."),
        ...
        ("Username must be at most 32 characters.", "Username must be at most 32 characters."),
        (
        ...
        ("verify_rustdesk_password_tip", "Verify DaFu Remote password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use DaFu Remote and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade DaFu Remote Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent DaFu Remote from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by DaFu Remote"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if DaFu Remote window is open"),
        ...
        ("floating_window_tip", "It helps to keep DaFu Remote background service"),
        ...
        ("About RustDesk", "About DaFu Remote"),
        ...
        ("Please use the installer package to upgrade.", "Please use the installer package to upgrade."),
        ("View camera", "View camera"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the DaFu Remote client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, DaFu Remote verifies the server certificate for protocols using TLS.\nWith this option enabled, DaFu Remote will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, DaFu Remote will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: DaFu Remote server OSS doesn't include this feature."),
        ...
        ("Show RustDesk", "Show DaFu Remote"),
    ].iter().cloned().collect();
}

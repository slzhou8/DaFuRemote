...
class ColorThemeExtension extends ThemeExtension<ColorThemeExtension> {
  ...
  static final light = ColorThemeExtension(
    ...
    border2: ModernTheme.borderLight,
    border3: ModernTheme.textTertiaryLight.withOpacity(0.35),
    highlight: ModernTheme.surfaceVariantLight,
    drag_indicator: ModernTheme.textSecondaryLight,
    shadow: Colors.black.withOpacity(0.15),
    errorBannerBg: ModernTheme.errorLight.withOpacity(0.12),
    me: ModernTheme.successLight,
    toastBg: ModernTheme.textPrimaryLight.withOpacity(0.82),
    toastText: Colors.white,
    divider: ModernTheme.borderLight,
  );

  static final dark = ColorThemeExtension(
    border: ModernTheme.borderDark,
    border2: ModernTheme.textSecondaryDark.withOpacity(0.6),
    border3: ModernTheme.textTertiaryDark.withOpacity(0.45),
    highlight: ModernTheme.surfaceVariantDark,
    drag_indicator: ModernTheme.textSecondaryDark,
    shadow: Colors.black.withOpacity(0.45),
    errorBannerBg: ModernTheme.errorDark.withOpacity(0.16),
    me: ModernTheme.successDark,
    toastBg: ModernTheme.surfaceVariantDark.withOpacity(0.92),
    toastText: ModernTheme.textPrimaryDark,
    divider: ModernTheme.borderDark,
  );
...
class MyTheme {
  ...
  static const Color grayBg = ModernTheme.surfaceVariantLight;
  static const Color accent = ModernTheme.primaryLight;
  static const Color accent50 = Color(0x776366F1);
  static const Color accent80 = Color(0xAA6366F1);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = ModernTheme.borderLight;
  static const Color idColor = ModernTheme.secondaryLight;
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = ModernTheme.primaryLight;
  static const Color hoverBorder = ModernTheme.borderLight;
...
Future<bool> shouldBlockSelfConnect(String id) async {
  final normalizedId = id.replaceAll(' ', '');
  if (normalizedId.isEmpty) {
    return false;
  }
  final myId = (await bind.mainGetMyId()).replaceAll(' ', '');
  return myId.isNotEmpty && normalizedId == myId;
}
